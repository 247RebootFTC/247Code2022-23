...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.3986013986;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        motorfrontLeft = hardwareMap.get(DcMotorEx.class, "motorbackLeft");
        motorbackLeft = hardwareMap.get(DcMotorEx.class, "motorfrontLeft");
        motorbackRight = hardwareMap.get(DcMotorEx.class, "motorfrontRight");
        motorfrontRight = hardwareMap.get(DcMotorEx.class, "motorbackRight");
